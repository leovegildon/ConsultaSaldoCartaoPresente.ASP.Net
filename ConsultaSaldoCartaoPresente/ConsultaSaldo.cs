...
{
    public partial class ConsultaSaldo : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var httpWebRequest = (HttpWebRequest)WebRequest.Create("https://blast.preprod.blackhawk-net.com:8443/transactionManagement/v2/transaction");
...
"}";
                ...
                using (var streamReader = new StreamReader(httpResponse.GetResponseStream()))
                {
                    ...
                    txtUpc.Text = "";
                    txtSaldo.Text = dados.response.transaction.additionalTxnFields.balanceAmount;
        ...
        private void txtUpc_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                //Executa o evento click do botão de enviar a mensagem
